...
{
    public function getshowIndex($limit = 5, $order = 'date_news')
    {
...
//        $date = date("Y-m-d H:i:s");
    ...
    public function getNewsshowById($id)
    {
        $this->count_visit($id);
    ...
    public function getNewsshowByTagId($id, $page = 0, $limit = 10)
    {
        $start = $page * $limit;
        $sql = "select n.*,t1.id_tag,t1.tag_name from news n
                left join tag_news t on t.id_news=n.id_news
...
//        echo $sql;
    ...
    public function getNewsshowByPage($page = 0, $limit = 10)
    {
        $start = $page * $limit;
